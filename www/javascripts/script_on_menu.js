function loadPage(num, onward){
	...
	$.get(lstAddress, function(data){
		...
		for (var i = 0; i < myList.length; i++){
			...
			var col = '<div class="block" style="background:#FFFFFF;width:100%;margin-left:0;padding:1% 4% 1% 4%"><div class = "row blockr" id='+num+'@'+i+'  style="background-color:'+(flag?"#178ED3":"#F6F7F7")+';width:100%;margin-left:0;padding:3% 3% 3% 3%"><table style="100%;"><tr><th style="width:60px"><img class="img-circle circle" src='+imgAddress+"TeamLogo/"+myList[i].TeamLogo+' style="height:55px;width:55px"></img></th><th style="width:57%;padding-left:2%"><span style="font-size:0.6em;color: rgb(2, 65, 126);font-weight:normal">'+myList[i].TeamName+'</span></th><th style="width:47%"><span class="glyphicon glyphicon-star" style="font-size:23px;color: rgb(2, 65, 126);"></span><span style="font-size:29px;font-style:italic;padding-left:11%;color: rgb(2, 65, 126); font-family:GillSans-BoldItalic;">'+myList[i].lntegral+'</span></th></tr></table></div></div>';
